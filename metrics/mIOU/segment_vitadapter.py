...
# CAVEAT: the script won't run without this seemingly unused import
# see https://github.com/czczup/ViT-Adapter/issues/29
...
def main(args):
    ...
    sample_ids = [f.name for f in images_path.iterdir() if f.name.endswith(".png")]
    for filename in tqdm(sample_ids):
        file_name = predlbl_path.joinpath(filename)
        ...
        with torch.no_grad():
            ...
            # yield result[0]
            cv2.imwrite(str(predlbl_path.joinpath(filename)), result[0])
